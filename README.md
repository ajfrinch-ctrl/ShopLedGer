...
- **Preview-first workflow (no needless downloads)** — প্রতিটি রিপোর্ট/হিসাব বিবরণী/রসিদ আগে **প্রিভিউ পপ-আপে** পুরোপুরি দেখা যায়; সেইখান থেকে **PDF ডাউনলোড** ও **শেয়ার/WhatsApp** (আসল PDF ফাইল শেয়ার হয়)। না দেখে বা না চাইলে কিছুই ডাউনলোড হয় না। **No print option** (mobile-first).
