...
import { Eye, EyeOff, Fingerprint, Lock, Phone } from "lucide-react";
...
function LoginPage() {
  ...
  // নম্বর লিখলে দেখা যায় এতে ফিঙ্গারপ্রিন্ট লগইন সেট আছে কিনা
  useEffect(() => {
    let live = true;
  ...
  return (
    <div className="relative flex min-h-dvh flex-col items-center justify-center overflow-x-hidden overflow-y-auto bg-primary px-4 py-8">
      ...
      <p className="relative z-10 mt-6 text-caption text-mint-2">
        অফলাইনেও কাজ করে • ডাটা এই ডিভাইসে সেভ হয়
      </p>
    </div>
  );
}
